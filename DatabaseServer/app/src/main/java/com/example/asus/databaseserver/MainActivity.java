package com.example.asus.databaseserver;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean SaveData() {
        ...
        String strStatusID = "0"; String strError = "Unknow Status!";
        JSONObject c;
        try { c = new JSONObject(resultServer);
        ...
        if(strStatusID.equals("0")){
            ...
            dialog.show(); txtName.setText(""); txtMsg.setText(""); txtAmt.setText(""); return true;
        }
    }// end SaveData()
